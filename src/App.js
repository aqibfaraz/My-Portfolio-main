            ...
            {isHomePage ? (
              ...
              <>
                ...
                <a href="/blog" style={{
                  fontFamily: "'Space Mono',monospace", fontSize: 11,
                  letterSpacing: "0.18em", textTransform: "uppercase",
                  color: location.pathname.startsWith("/blog") ? "#00cc99" : "rgba(255,255,255,0.4)",
                  textDecoration: "none",
                  transition: "color 0.2s",
                }}
                  onMouseEnter={e => e.target.style.color = "#00cc99"}
                  onMouseLeave={e => e.target.style.color = location.pathname.startsWith("/blog") ? "#00cc99" : "rgba(255,255,255,0.4)"}
                >Blog</a>
              </>
            )}
          </div>
          ...
          {isHomePage ? (
            ...
            <>
              ...
              <a href="/blog" onClick={() => setOpen(false)} style={{
                display: "block", fontFamily: "'Space Mono',monospace",
                fontSize: 13, letterSpacing: "0.18em", textTransform: "uppercase",
                color: location.pathname.startsWith("/blog") ? "#00cc99" : "rgba(255,255,255,0.55)",
                textDecoration: "none",
                padding: "15px 0", borderBottom: "1px solid rgba(255,255,255,0.04)",
              }}>Blog</a>
            </>
